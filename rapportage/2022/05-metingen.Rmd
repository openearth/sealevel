...
(ref:satellieten-label) Overzicht van de historie van de \acr{NAP} merken in de buurt van de meetstations over de hele periode van beschikbare gegevens.

```{r satellieten, fig.cap="(ref:satellieten-label)" }
=======
...
>>>>>>> 41628e6cddf751161017eec334a2528309bb5149
...
Door de covariantie tussen satellietparen wordt met kriging (een interpolatie techniek) een vlak gefit. Hiermee wordt in de ruimte geïnterpoleerd. In de tijd wordt lineair geïnterpoleerd. De gegevens worden ter validatie vergeleken met data die weggelaten is uit het verwerkingsproces en met getijstations. De nauwkeurigheid ligt in de orde van 4 cm (\acr{RMS}).

...
De eerste waterstandsmetingen aan de Nederlandse kust zijn gestart in het jaar 1700 in Amsterdam. Sinds de invoering van het [NAP]{acronym-label="NAP" acronym-form="singular+short"} zijn de gegevens ook geschikt om zeespiegeltrends mee te bepalen.
...
<!-- ![Overzicht van de beschikbare waterstandsmetingen van de stations die waterstanden meten langs de kust. Rood/groen: actief/niet actief, Stippel/doorgetrokken lijn: meting t.o.v [NAP]{acronym-label="NAP" acronym-form="singular+short"} (kust)/meting t.o.v. [MSL]{acronym-label="MSL" acronym-form="singular+short"} (buitengaats)](waterbase){#fig:waterbase width="\\textwidth"} -->

```{r waterbase, fig.cap= "Overzicht van de beschikbare waterstandsmetingen van de stations die waterstanden meten langs de kust. Rood/groen: actief/niet actief, Stippel/doorgetrokken lijn: meting t.o.v NAP (kust)/meting t.o.v. MSL (buitengaats)."}
...
Dit station ligt aan de kade in Vlissingen (51.44210°N, 3.59610°O), nabij de buitenhaven. Het fundament is een stalen damwand met een diepte van -17.6m NAP, en een breedte van 2.2m. Binnen deze damwand liggen de meetinstrumenten. De onderwater kamer is een afgesloten betonnen plaat die zich bevindt op -4.0m NAP tot -5.0m NAP. Het station heeft een [GNSS]{acronym-label="GNSS" acronym-form="singular+short"}. Tijdens de storm van 1953 overstroomde de kade waarop het station staat. Hiervan zijn [filmbeelden](https://www.youtube.com/watch?v=bMhM449AarI) beschikbaar.
...
Het getijstation in Harlingen bevindt zich in de haven op de boulevard. Op een diepte van -2.56m NAP loopt een pijp van het station naar zee. De inlaat van de buis wordt beschermd door een constructie, om de variaties door de golfinslag te verminderen. Het hoofdgebouw heeft een fundament van een stalen damwandconstructie met rechthoekige binnenafmetingen 2.53 x 2.27 m^2^ rondom de meetinstrumenten. De 28m lange nulpaal staat op een diepte van 22m. In de buurt van dit station start zoutwinning.
...
In Nederland wordt de hoogte nauwkeurig vastgesteld sinds de invoering van het [NAP]{acronym-label="NAP" acronym-form="singular+short"}. Oorspronkelijk lag het [NAP]{acronym-label="NAP" acronym-form="singular+short"} op het gemiddelde hoogwaterniveau in het IJ, van voor de afsluiting in 1872 [@Weele1971], 9 voet, 5 duim, Amsterdamse maat (2.68m) boven Stads Peyl. De Rijkscommissie Graadmeting voor Waterpassing (nu [NCG]{acronym-label="NCG" acronym-form="singular+short"}) voerde de eerste serieuze waterpassingen uit, waarmee het invoeren van het [NAP]{acronym-label="NAP" acronym-form="singular+short"} mogelijk werd. Rijkswaterstaat ([CIV]{acronym-label="CIV" acronym-form="singular+short"}) is verantwoordelijk voor het beheer van het [NAP]{acronym-label="NAP" acronym-form="singular+short"}, in samenwerking gedaan met het Kadaster.

Het [NAP]{acronym-label="NAP" acronym-form="singular+short"} wordt gebruikt om Nederlandse zeespiegelmetingen aan de kust uit te drukken. Het is gebaseerd op de ruim 30 duizend peilmerken. Het is geldig binnen het domein waar de peilmerken zich bevinden. Op zee en voor satellietmetingen op de oceaan is het niet bruikbaar.

Voor internationale uitwisseling van gegevens van getijstations wordt gebruik gemaakt van een [RLR]{acronym-label="RLR" acronym-form="singular+short"}. Voor Nederland wordt dit gebruikt om de [NAP]{acronym-label="NAP" acronym-form="singular+short"} correctie door te voeren, zoals beschreven in @Dillingh2010. Doordat een correctie van de hoogte van de peilmerken is doorgevoerd zijn metingen van voor 2005 niet gemeten ten opzichte van de huidige hoogte van het [NAP]{acronym-label="NAP" acronym-form="singular+short"}. Hier komen we zo weer op terug.

Naast het [NAP]{acronym-label="NAP" acronym-form="singular+short"} zijn ook andere hoogtesystemen in gebruik. De [IHO]{acronym-label="IHO" acronym-form="singular+short"} schrijft het gebruik van [LAT]{acronym-label="LAT" acronym-form="singular+short"} voor op de Noordzee. Dit niveau verschilt langs de kust en ligt op ongeveer 2,5m onder [NAP]{acronym-label="NAP" acronym-form="singular+short"} [@Slobbe2013]. In de Verenigde Staten wordt hiervoor [MLLW]{acronym-label="MLLW" acronym-form="singular+short"} gebruikt.
...
### Het NAP en de nulpalen {#nulpaal}

Terug naar de zeespiegel langs de Nederlandse kust. Deze meten we ten opzichte van het [NAP]{acronym-label="NAP" acronym-form="singular+short"}. Voor de bepaling van de relativiteit van de stijging van de zeespiegel is het vooral van belang ten opzichte van welk punt de zeespiegel wordt gemeten. Dat werkt als volgt. In het peilhuis staat een [DNM]{acronym-label="DNM" acronym-form="singular+short"}, de moderne variant van een peilschrijver. Een ouderwetse peilschrijver is nog te zien in het peilhuisje in Herwijnen. Deze [DNM]{acronym-label="DNM" acronym-form="singular+short"} wordt periodiek gecalibreerd ten opzichte van de [NAP]{acronym-label="NAP" acronym-form="singular+short"} bout in het station. De hoogte van deze peilbout wordt gebaseerd op basis van een nabijgelegen vast punt.

Doordat het [NAP]{acronym-label="NAP" acronym-form="singular+short"} een lange historie heeft en niet alle gegevens openbaar beschikbaar zijn is het niet met zekerheid vast te stellen hoe het [NAP]{acronym-label="NAP" acronym-form="singular+short"} praktisch geïmplementeerd is. Op basis van de beschikbaar gestelde documenten en data komen we tot de volgende beschrijving.

Bij alle getijstations staan nulpalen (1e orde merken) die als vast worden verondersteld. Tot de invoering van de nulpalen [@Wemelsfelder1958] werden aan de kust bovengrondse peilmerken (2e orde merken, meestal geplaatst in openbare gebouwen) gebruikt [@Bruijne2005].

Het [NAP]{acronym-label="NAP" acronym-form="singular+short"} is dus geïmplementeerd als het vlak door de als vast veronderstelde ondergrondse merken. Per waterpassing is opnieuw bepaald welke merken als vast gehanteerd konden worden. Ter gelegegenheid van het 200 jarig bestaan van het (N)AP is een overzicht van de historie van het [NAP]{acronym-label="NAP" acronym-form="singular+short"} beschreven door @Dam2018 en eerder door @Weele1971. De historie is belangrijk omdat er niemand meer leeft die betrokken was bij de eerste waterpassing in 1888.

In de loop van de jaren 1990 ontstond het inzicht dat verschillende peilmerken toch niet zo vast waren. Daarom is een revisie doorgevoerd (ook wel bekend als de NAP correctie) in de hoogte van de nulpalen [@Brand2004]. Anders gezegd, het NAP referentiesysteem is opnieuw gerealiseerd wat heeft geleidt tot nieuwe hoogtes van de peilmerken (dat is, een nieuw referentiestelsel). Aangezien voor de analyses van zeespiegelgegevens consistentie in het gebruikte referentiestelsel wenselijk is, wordt de sprong in de zeespiegelmetingen als gevolg van de herziening van het NAP verwijderd, zoals eerder beschreven in @Dillingh2010.

Dan nog een uitzondering voor het station van Delfzijl. In de vorige paragraaf beschreven we dat de nulpalen als constant werden verondersteld. Dit is niet het geval voor het station van Delfzijl. Toen geconstateerd werd dat de bodem onder Groningen snel daalde ontstond de vraag of ten opzichte van de lokale nulpaal of ten opzichte van de nulpaal voor de bodemdaling begon moet worden gemeten. Uiteindelijk is besloten de nulpaal van Delfzijl en andere nabijgelegen nulpalen van het [NAP]{acronym-label="NAP" acronym-form="singular+short"} los te koppelen [@Jong1973]. Het [NAP]{acronym-label="NAP" acronym-form="singular+short"} werd bepaald ten opzichte van peilmerken buiten de bodemdalingsschotel van Groningen. Hierdoor zit de bodemdaling van Groningen niet in de metingen van het station van Delfzijl en moeten we die er nog apart bij optellen om de relatieve zeespiegelstijging te bepalen.

### NAP historie {#sec:nap-historie}

Vanuit de historie van [NAP]{acronym-label="NAP" acronym-form="singular+short"} merken hebben we een overzicht gemaakt van de hoogtes van de merken. Deze overzichten zijn niet bedoeld om de bodemdaling absoluut vast te stellen maar te verifïeren dat Delfzijl wel en Hoek van Holland niet van het [NAP]{acronym-label="NAP" acronym-form="singular+short"} zijn losgekoppeld. In [2](#fig:nulpalen){reference-type="ref" reference="fig:nulpalen"} is een overzicht weergegeven van de Nulpalen in de buurt van de getijdestations. Hierin is te zien dat de nulpalen allemaal van hoogte zijn veranderd in de revisie, de [NAP]{acronym-label="NAP" acronym-form="singular+short"} correctie in 2005. Een deel van de hoogtes in het archief is reviseerd. Daarnaast is te zien dat de nulpaal van Delfzijl is losgekoppeld van het [NAP]{acronym-label="NAP" acronym-form="singular+short"}. De hoogte is niet constant. Ten slotte zien we dat de hoogte van Den Helder is aangepast tussen de vierde en vijfde waterpassing. Het is onduidelijk waarom.
...
```{r nulpalen, fig.cap="Overzicht van de historie van de NAP merken in de buurt van de meetstations. Relatief ten opzichte van de eerste meting. (nulpalen)" }
knitr::include_graphics("figures/nulpalen.png")
```



```{r satellieten, fig.cap="Overzicht van de historie van de NAP merken in de buurt van de meetstations over de hele periode van beschikbare gegevens." }
knitr::include_graphics("figures/nap-history.png")
```

## Satellietmeting van de zeehoogte

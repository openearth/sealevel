...
Vanuit de historie van [NAP]{acronym-label="NAP" acronym-form="singular+short"} merken hebben we een overzicht gemaakt van de hoogtes van de merken. In [3](#fig:nap-history){reference-type="ref" reference="fig:nap-history"} zien we dat de nulpaal bij het peilstation van Delfzijl zakt ten opzichte van het [NAP]{acronym-label="NAP" acronym-form="singular+short"}. De overige stations zijn grotendeels onveranderd ten opzichte van het [NAP]{acronym-label="NAP" acronym-form="singular+short"}-vlak. De grootste afwijking zijn te herleiden tot de herziening van het [NAP]{acronym-label="NAP" acronym-form="singular+short"}-vlak in 2005. 

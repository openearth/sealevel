...
```{r allVariantsGTSM-linear, fig.height=10, fig.width=8, fig.cap="Model fits with linear model and GTSM surge correction for all stations"}
...
plot_all_stations <- function(predictions_all = predictions_all, correctionVariant, modelVariant) {
  ...
  plotColors = c(
    ...
    "predictie (-getij -anomalie)" = pal[3],
    "zeespiegel (-anomalie)" = pal[4]
  )
...
```{r allVariantsGTSM-brokenlinear, fig.height=10, fig.width=8, fig.cap="All variants"}
...
```{r allVariantsGTSM-quadratic, fig.height=10, fig.width=8, fig.cap="All variants"}
...
```{r allVariantsGTSM-brokenquadratic, fig.height=10, fig.width=8, fig.cap="All variants"}
...
```{r allVariantsNCEP-linear, fig.height=10, fig.width=8, fig.cap="All variants"}
...
```{r allVariantsNCEP-brokenlinear, fig.height=10, fig.width=8, fig.cap="All variants"}
...
```{r allVariantsNCEP-quadratic, fig.height=10, fig.width=8, fig.cap="All variants"}
...
timeseries %>%
  select(year, name_rws, correction_variant, `Nodal U`, `Nodal V`) %>%
  pivot_longer(cols = c(`Nodal U`, `Nodal V`), names_to = "component", values_to = "waarde") %>%
  ggplot() +
  geom_histogram(aes(waarde, fill = correction_variant), size = 1, binwidth = 0.5) +
  facet_grid(name_rws ~ component, scales = "free") +
  theme_minimal() +
...
```{r trends, fig.height=8, fig.width=8}
startyear = 1978

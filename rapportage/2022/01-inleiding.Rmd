# Inleiding (OUDE VERSIE: AANPASSEN) {#inleiding}
...
# knitr::include_graphics("path-to-relatievezeespiegel-figure")
```

<!-- \begin{figure}[htbp] -->
<!--   \centering -->
<!--   \includegraphics[width=\linewidth]{relatievezeespiegel} -->
<!--   \caption[Relatieve zeespiegel]{Relatieve versus absolute zeespiegelstijging.} -->
<!--   \label{fig:relatievezeespiegel} -->
<!-- \end{figure} -->

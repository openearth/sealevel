...
<<<<<<< HEAD
Dit rapport heeft als doel om een overzicht te geven van het onderzoek dat in de afgelopen jaren is gedaan in het kader van het onderzoek Kustbeleid. Vanaf 2018 is er richting gegeven aan dit onderzoek vanuit een met de opdrachtgevers afgestemde onderzoeksagenda. In dit rapport worden de volgende centrale vraagstellingen beantwoord.Veel van deze onderzoeken zijn ook als aparte memo's of rapporten gepresenteerd, zie \@ref(bijlagerapporten).
=======
Dit rapport heeft als doel de volgende centrale vraagstellingen te beantwoorden. Daarnaast zijn er andere onderzoeksvragen beantwoord in diverse memo's, in bijlage \@ref(bijlagerapporten).

**Missiegedreven beleid**

(ref:vraag-globaal) breid de zeespiegelmonitor uit tot een globaal dekkend, lokaal toepasbare zeespiegelmonitor.
...
-   '(ref:vraag-globaal)'
-   '(ref:vraag-kwaliteitsindicatoren)'
...
-   (ref:vraag-faq) Onderhoud FAQ.
>>>>>>> 3acc47fcef3434b03a2a6d3d84e07089245ce428
...
Merk op dat de paginanummers van bovenstaande vragen in de digitale versie van dit document voorzien zijn van een hyperlink. Hiermee kunt u klikken naar de juiste pagina. Dit geldt ook voor verwijzingen naar acroniemen waarmee u bij het overzicht van afkortingen kunt komen, te vinden in \@ref{acroniemen}.

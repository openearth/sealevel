...
```{r amo, fig.cap='Atlantische Multidecadale Oscilllatie, een hoge waarde hangt samen met een warme Noord Atlantische Oceaan, data: [NOAA]{acronym-label="NOAA" acronym-form="singular+short"}.'}knitr::include_graphics("figures/amo.png")
```

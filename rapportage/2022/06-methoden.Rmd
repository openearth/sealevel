...
Global sea level rise accelerated from the 1960th as a result of the sharp increase in greenhouse gas emissions after the 2nd world war (Slangen et al. 2016, Dangendorf et al. 2019). Using a sophisticated statistical method this is also what is found along the Dutch coast (Keizer et al. submitted). This is why we test a model with an acceleration term from 1960.
...
NOG TOEVOEGEN: VERWIJZING NAAR STUDIES TU EN KNMI

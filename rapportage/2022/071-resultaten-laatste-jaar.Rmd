# Resultaten voor het actuele jaar {#resultaten}
...
```{r gtsm-opzet, fig.cap="Windopzet zoals gebruikt in de Zeespiegelmonitor. Vanaf 1950 is een jaarlijks gemiddelde opzet berekend met GTSM, in de periode daarvoor wordt een gemiddelde opzet gebruikt."}
results2023 %>%

...
\authorii{Willem Stolte, Fedor Baart, Sanne Muis, Marc Hijma, Marcel Taal (Deltares), Dewi Le Bars, Sybren Drijfhout (KNMI)}
\dateii{04-05-2023}
\organisationii{Deltares}
\versionii{1.0}
\reviewerii{Bart van den Hurk}
\approvalii{Toon Segeren}
...
{\centering \includegraphics[width=0.85\linewidth]{figures/samenvatting_v2} 

...
:   de wijze waarop de toepassing is opgeschreven en de interpretatie

Grootheid

:   bijvoorbeeld hoogwater, laagwater, gemiddelde waterstand
...
De overheid heeft zich als taak gesteld om de
kustlijn en het kustfundament dynamisch te handhaven. We werken hier de verschillende aspecten verder uit.
...
actuele zeespiegel is dus de indicator die voor het beheer en
...
inzichten. Er is tevens een door \{EZK} een uitwerking gemaakt voor het eventueel aanpassen van de winning in geval van crisis, [het bescherm- en herstelplan gas](https://open.overheid.nl/repository/ronl-c696bb3e-b8a9-411f-aabd-f539bc0ebed2/1/pdf/Bescherm%20en%20Herstelplan%20Gas.pdf). 
...
In \acr{WBI} ([weblink](https://www.helpdeskwater.nl/onderwerpen/waterveiligheid/primaire/beoordelen/beoordelingsinstrumentarium-wbi2017-0/)) zijn de toeslagen voor
...
belemmering vormen voor het proces van afslag. Dit is

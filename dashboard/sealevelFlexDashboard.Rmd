...
renderPlotly({
  ...
  if(length(input$exclude) != 0){
    fig = fig +
      geom_point(data = sealevelPlus2, aes(year, value, color = "excluded processes"), size = 2, alpha = 0.6) +
      geom_line(data = sealevelPlus2, aes(year, value, color = "excluded processes"), size = 2, alpha = 0.6) +
      geom_line(data = knmi_mapped2, aes(year, value, color = "excluded processes"), size = 2, alpha = 0.6)
  }

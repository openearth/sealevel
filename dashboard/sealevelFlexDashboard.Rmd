...
fillPage(
  fillCol(height = "80%", flex = c(NA,1), 
          h3("Dutch Sea Level Visualization. Concept version"),
          actionButton(
            "clickMe",
...
This app visualizes the sea level at the Dutch coast. This version is still in concept. 

Known issues:

*   The effect of tide is currently not properly included yet. 
...
*   The underlying processes of observations and projections have been visualiazed together.

...
bsPopover(id = "scenario", 
          title = "Het door KNMI berekende scenario dat getoond wordt", 
          content = paste("rcp45 = .........;", 
                          "rcp85 = .......", 
                          sep = "<br>"), 
...
bsTooltip(id = "mode", title = "expert mode to separate between processes", 
          placement = "bottom", trigger = "hover")
...
renderPlotly({
  ...
  fig <- fig + 
    ...
    annotate("text", label = "NAP", x = 1900, y = 25, size = 8, color = "bisque4") +

...
showSE = 0.4 # alpha for all smoothings
  ...
  tabsetPanel(
    tabPanel("Processes",
             ...
             checkboxGroupButtons(
               inputId = "exclude",
               label = "Choose the underlying processes for sea level change that you want to exclude from the chart:",
               choices = processes,
               direction = "vertical"
             )
    ),

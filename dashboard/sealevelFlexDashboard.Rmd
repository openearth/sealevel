...
observation_mapping <- list(surge="Surge [mm]", steric="Steric [mean]",	glaciers="Glaciers [mean]", greenland="Greenland Ice Sheet [mean]", antarctica="Antarctic Ice Sheet [mean]", land="Terrestrial Water Storage [mean]",	gia="GIA [mean]", tide='sea_surface_height_due_to_tide [mm]')
knmi_mapping <- list(steric="Local ocean", surge="Inverse barometer", glaciers="Glaciers", land="Landwater", antarctica="sum anta.", greenland="Greenland SMB")
mapping <- list(observations=obversation_mapping, knmi=knmi_mapping)
